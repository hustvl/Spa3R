...
import spa3_vlm.train.trainer
from spa3_vlm.data.data_qwen import make_supervised_data_module
from spa3_vlm.train.argument import ModelArguments, DataArguments, TrainingArguments
from spa3_vlm.train.trainer import replace_qwen2_vl_attention_class
...
def train(attn_implementation="flash_attention_2"):
    ...
    if "qwen2.5" in model_args.model_name_or_path.lower():
        if not model_args.use_geometry_encoder:
            ...
            if (
                hasattr(config, "use_geometry_encoder")
                and config.use_geometry_encoder != model_args.use_geometry_encoder
            ):
                raise ValueError(
